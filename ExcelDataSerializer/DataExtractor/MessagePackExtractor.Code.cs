...
";
    ...
    private const string DATA_TABLE_CLASS = @"namespace Client;
...
static class TypesExtension
{
    ...
    private const string EXTRACTOR_CLASS = $@"using System;
using System.IO;
...
class Extractor
{{
    private const string TYPE_NAMESPACE = ""{Constant.DATA_NAMESPACE}"";
